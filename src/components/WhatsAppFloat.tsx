...
const WhatsAppFloat = () => {
  const phoneNumber = "971502027474" // Your phone number without + and spaces
  const message = "Hello! I'm interested in your surveying services."
  ...
  return (
    ...
    >
      <motion.button
        ...
        className="text-white p-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center group relative overflow-hidden"
